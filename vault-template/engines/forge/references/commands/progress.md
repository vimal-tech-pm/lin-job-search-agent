...
The value of `progress` scales with the data available. Before running the full protocol, assess what's in `memory/coaching_state.md` and adapt:
...
Log outcomes in `memory/coaching_state.md` (Score History and Outcome Log sections).

...
2. If `memory/coaching_state.md` has an active Interview Loop for a company with a known next round, use that stage.
...
After generating questions, save the top 3 to `memory/coaching_state.md` so other commands can reference them:

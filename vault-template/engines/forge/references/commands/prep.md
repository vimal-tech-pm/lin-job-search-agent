...
After running Format Discovery, save the format details to `memory/coaching_state.md` so subsequent commands don't re-ask:
...
If `memory/coaching_state.md` shows previous rounds at the same company, this is a continuation prep, not a fresh start:

...
- Calibration gap: Accurate on this one. Good self-awareness. (Note: across 4 prior rounds, candidate has consistently rated Structure 1 point higher than coach scores — this pattern hasn't surfaced here but is tracked in `memory/coaching_state.md`.)

...
**Score → Verdict mapping (MANDATORY):**

| Score | Verdict | Meaning |
|-------|---------|---------|
| ≥ 4.5 | Strong apply | Exceptional fit — apply immediately |
| 4.0 – 4.4 | Investable | Good match, worth applying |
| 3.5 – 3.9 | Investable Stretch | Decent but not ideal, apply if specific reason |
| 3.0 – 3.4 | Long-Shot Stretch | Marginal fit, apply only if desperate or uniquely positioned |
| < 3.0 | SKIP | Weak match, recommend against applying |

**Use these exact verdict strings.** The verdict reflects ROLE FIT ONLY. Do NOT fold location, visa, or Canada eligibility into the verdict — those are separate geo-gates handled by the pipeline. A role can be score 4.0 / verdict "Investable" even if it's US-only remote. The geo_gate blocks staging; the verdict tells the user how good the role fit is.
